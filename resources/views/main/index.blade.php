                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="stats-item text-center w-100 h-100">
                            <div style="display: flex;margin: 0 6rem">
                                <span data-purecounter-start="0" data-purecounter-end="{{ $student_counts }}"
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="stats-item text-center w-100 h-100">
                            <div style="display: flex;margin: 0 6rem">
                                ...
                                <span data-purecounter-start="0" data-purecounter-end="{{ $course_counts }}"
                                    data-purecounter-duration="1" class="purecounter"></span>
                                <span>+</span>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="stats-item text-center w-100 h-100">
                            <div style="display: flex;margin: 0 6rem">
                                ...
                                <span data-purecounter-start="0" data-purecounter-end="{{ $event_counts }}"
                                    data-purecounter-duration="1" class="purecounter"></span>
                                <span>+</span>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="stats-item text-center w-100 h-100">
                            <div style="display: flex;margin: 0 6rem">
                                ...
                                <span data-purecounter-start="0" data-purecounter-end="{{ $trainer_counts }}"
                                    data-purecounter-duration="1" class="purecounter"></span>
                                <span>+</span>
                                ...
                                <div class="course-content">
                                    ...
                                    <div class="trainer d-flex justify-content-between align-items-center">
                                        <div class="trainer-profile d-flex align-items-center">
                                            ...
                                            <img src="{{ $course->teacher->user->profile_photo_path }}" class="img-fluid"
                                                alt="">
                                            <a href="/dashboard" style="margin-left: 2em;">
                                                {{ $course->teacher->user->name }} </a>
                                        </div>
