    ...
    <main class="main">
        ...
        <section id="courses-course-details" class="courses-course-details section">
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row">
                    <div class="col-lg-9 text-center" style="margin: 0 8rem;">
                        @if (session('success'))
                        ...
                        <div>
                            @if ($isEnrolled)
                                <a href="{{ route('courses.view', $course->id) }}">
                                    <button
                                        style="border: 2px;border-radius: 30px;background-color: #5fcf80; margin:0 35%;padding:10px 15px;color:azure">
                                        View
                                    </button>
                                </a>
                            @else
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active show" id="tab-1">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 text-center order-1 order-lg-2">
                                        <img src="{{ asset('assets/img/tabs/tab-1.png') }}" alt=""
                                            class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane" id="tab-2">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 text-center order-1 order-lg-2">
                                        <img src="{{ asset('assets/img/tabs/tab-2.png') }}" alt=""
                                            class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane" id="tab-3">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 text-center order-1 order-lg-2">
                                        <img src="{{ asset('assets/img/tabs/tab-3.png') }}" alt=""
                                            class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane" id="tab-4">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 text-center order-1 order-lg-2">
                                        <img src="{{ asset('assets/img/tabs/tab-4.png') }}" alt=""
                                            class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane" id="tab-5">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 text-center order-1 order-lg-2">
                                        <img src="{{ asset('assets/img/tabs/tab-5.png') }}" alt=""
                                            class="img-fluid">
                                    </div>
                                </div>
                            </div>
