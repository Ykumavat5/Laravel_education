        ...
        <section id="courses" class="courses section">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <form action="{{ route('assignment.update',$assignment->id) }}" method="post" data-aos="fade-up" data-aos-delay="200"
                        ...
                        <div class="row gy-4">
                            <div class="col-md-12">
                                ...
                                <select id="courseSelect" name='standard_division_id' class="form-control"
                                    ...
                                    <option value="{{ $assignment->standard_division_id }}">
                                        {{ $assignment->standard_division_id }}</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" id="subject" name="subject" class="form-control"
                                    placeholder="Enter Subject Name" required="" value="{{ $assignment->subject }}">
                                <span class='text-danger'>
                                    @error('subject')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" id="title" class="form-control" name="title"
                                    placeholder="Your title" required="" value="{{ $assignment->title }}">
                                <span class='text-danger'>
                                    @error('title')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control" id='description' name="description" placeholder="Your title">{{ $assignment->description }}</textarea>
                                <span class='text-danger'>
                                    @error('description')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="file" name="image" id="image" > <span class='text-danger'>
                                    <span class='text-danger'>
                                        @error('image')
                                            {{ $message }}
                                        @enderror
                            ...
                            <div class="col-md-6 mb-5">
                                ...
                                <input type="date" id="datepicker" name="duedate" class="form-control"
                                    oninput="this.className=''" autocomplete="off"
                                    value="{{ $assignment->due_date ? \Carbon\Carbon::parse($assignment->due_date)->format('Y-m-d') : '' }}">
                            ...
                            <div class="col-md-6 mb-5">
                                ...
                                <div class="input-group date" id="timePicker">
                                    ...
                                    <span class="input-group-addon"><i class="fa fa-clock-o mt-2"
                                            style="margin-left: -2rem;position: absolute;" aria-hidden="true"></i></span>
                                    <span class='text-danger'>
                                        @error('time')
                                            {{ $message }}
                                        @enderror
